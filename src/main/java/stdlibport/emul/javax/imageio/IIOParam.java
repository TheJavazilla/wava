...
public abstract class IIOParam {
    ...
    public void setSourceRegion(Rectangle sourceRegion) {
        ...
        this.sourceRegion = wava.helpers.Cloner.clone(sourceRegion);
    }
    ...
    public Rectangle getSourceRegion() {
        ...
        return (Rectangle)wava.helpers.Cloner.clone(sourceRegion);
    }
    ...
    public void setSourceBands(int[] sourceBands) {
        if (sourceBands == null) {
            ...
            this.sourceBands = (int[])wava.helpers.Cloner.clone(sourceBands);
        }
    }
    ...
    public int[] getSourceBands() {
        ...
        return wava.helpers.Cloner.clone(sourceBands);
    }
    ...
    public void setDestinationOffset(Point destinationOffset) {
        ...
        this.destinationOffset = wava.helpers.Cloner.clone(destinationOffset);
    }
    ...
    public Point getDestinationOffset() {
        return wava.helpers.Cloner.clone(destinationOffset);
    }
