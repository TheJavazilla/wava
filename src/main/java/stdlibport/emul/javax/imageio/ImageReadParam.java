...
public class ImageReadParam extends IIOParam {
    ...
    public void setDestinationBands(int[] destinationBands) {
        if (destinationBands == null) {
            ...
            this.destinationBands = (int[])wava.helpers.Cloner.clone(destinationBands);
        }
    }
    ...
    public int[] getDestinationBands() {
        if (destinationBands == null) {
            ...
            return (int[])wava.helpers.Cloner.clone(destinationBands);
        }
    }
    ...
    public void setSourceRenderSize(Dimension size)
        ...
        if (size == null) {
            ...
            this.sourceRenderSize = wava.helpers.Cloner.clone(size);
        }
    }
    ...
    public Dimension getSourceRenderSize() {
        return (sourceRenderSize == null) ?
            null : (Dimension)wava.helpers.Cloner.clone(sourceRenderSize);
    }
