...
public class AccessibleRole extends AccessibleBundle {
     ...
     * to a frame, but it has fewer properties and is often used as a secondary window for an application.
     */
     ...
     * used in interfaces to tweak the spacing between components, but serves no other purpose.
     */
     ...
     * user to select one or more of them.  A list is usually contained within a scroll pane.
     */
     ...
     * from.  For example, a menu bar might contain menus for "File," "Edit," and "Help."
     */
     ...
     * "Open," "Close," and "Exit," and will place a separator between "Close" and "Exit" menu items.
     */
     ...
     * mechanism is a list of tabs at the top of the panel. The children of a page tab list are all page tabs.
     */
     ...
     * It is often used to provide the most frequently used functions for an application.
     */
     ...
     * calculating a value.  An example is a formula in a spreadsheet cell.
     */
