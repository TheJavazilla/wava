    ...
    private Map<String, Object> getResourceCache(Locale l) {
        ...
        if (values == null) {
            ...
            for (int i=resourceBundles.size()-1; i >= 0; i--) {
                ...
                try {
                    Control c = null;// TODO WAVA Control c = CoreResourceBundleControl.getRBControlInstance(bundleName);
                    ResourceBundle b;
                    if (c != null) {
    ...
    public ComponentUI getUI(JComponent target) {
        ...
        if (uiClass == null) {
            ...
            try {
                ...
                // TODO WAVA uiObject = MethodUtil.invoke(m, null, new Object[]{target});
            }
                ...
                public Object run() {
                    try {
                        ...
                        if (methodName != null) {
                            ...
                            // TODO WAVA REFLECTION return MethodUtil.invoke(m, c, args);
                        } else {
                            Class[] types = getClassArray(args);
