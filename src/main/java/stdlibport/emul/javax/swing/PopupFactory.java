...
public class PopupFactory {
    ...
    private Popup getPopup(Component owner, Component contents,
        ...
        case HEAVY_WEIGHT_POPUP:
            ...
            // TODO WAVA if ((AccessController.doPrivileged(OSInfo.getOSTypeAction()) ==
            // TODO WAVA    OSInfo.OSType.MACOSX) && (owner != null) &&
            // TODO WAVA     (EmbeddedFrame.getAppletIfAncestorOf(owner) != null)) {
            // TODO WAVA     ((HeavyWeightPopup)popup).setCacheEnabled(false);
            // TODO WAVA }
            return popup;
        }
        return null;
