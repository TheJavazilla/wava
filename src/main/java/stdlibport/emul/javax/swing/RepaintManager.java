...
import wava.sun.awt.DisplayChangedListener;
...
import wava.sun.swing.SwingAccessor;
import wava.sun.swing.SwingUtilities2.RepaintListener;
        ...
        synchronized(this) {
            ...
            runnableList.add(new Runnable() {
                public void run() {
                    ...
                    // TODO WAVA javaSecurityAccess.doIntersectionPrivilege(new PrivilegedAction<Void>() {
