...
//TODO WAVA import wava.sun.awt.OSInfo;
import wava.sun.security.action.GetPropertyAction;
import wava.sun.swing.SwingUtilities2;
...
public class UIManager implements Serializable
{
    ...
    static {
     ...
     // TODO WAVA iLAFs.add(new LookAndFeelInfo("CDE/Motif",
     // TODO WAVA           "com.sun.java.swing.plaf.motif.MotifLookAndFeel"));

        // Only include windows on Windows boxs.
     // TODO WAVA OSInfo.OSType osType = AccessController.doPrivileged(OSInfo.getOSTypeAction());
     // TODO WAVA if (osType == OSInfo.OSType.WINDOWS) {
     // TODO WAVA  iLAFs.add(new LookAndFeelInfo("Windows",
     // TODO WAVA              "com.sun.java.swing.plaf.windows.WindowsLookAndFeel"));
     // TODO WAVA if (Toolkit.getDefaultToolkit().getDesktopProperty(
     // TODO WAVA         "win.xpstyle.themeActive") != null) {
     // TODO WAVA       iLAFs.add(new LookAndFeelInfo("Windows Classic",
     // TODO WAVA        "com.sun.java.swing.plaf.windows.WindowsClassicLookAndFeel"));
     // TODO WAVA }
     // TODO WAVA }
     // TODO WAVA else if (osType == OSInfo.OSType.MACOSX) {
     // TODO WAVA     iLAFs.add(new LookAndFeelInfo("Mac OS X", "com.apple.laf.AquaLookAndFeel"));
     // TODO WAVA }
     // TODO WAVA else {
     // TODO WAVA   // GTK is not shipped on Windows.
     // TODO WAVA     iLAFs.add(new LookAndFeelInfo("GTK+",
     // TODO WAVA           "com.sun.java.swing.plaf.gtk.GTKLookAndFeel"));
     // TODO WAVA  }
        ...
        throws UnsupportedLookAndFeelException
    {
        ...
        if (newLookAndFeel != null) {
            wava.sun.swing.DefaultLookup.setDefaultLookup(null);
    ...
    public static String getSystemLookAndFeelClassName() {
     ...
     // TODO WAVA OSInfo.OSType osType = AccessController.doPrivileged(OSInfo.getOSTypeAction());
     // TODO WAVA if (osType == OSInfo.OSType.WINDOWS) {
     // TODO WAVA     return "com.sun.java.swing.plaf.windows.WindowsLookAndFeel";
     // TODO WAVA } else {
     // TODO WAVA String desktop = AccessController.doPrivileged(new GetPropertyAction("wava.sun.desktop"));
     // TODO WAVA   Toolkit toolkit = Toolkit.getDefaultToolkit();
     // TODO WAVA if ("gnome".equals(desktop) &&
     // TODO WAVA          toolkit instanceof SunToolkit &&
     // TODO WAVA         ((SunToolkit) toolkit).isNativeGTKAvailable()) {
     // TODO WAVA      // May be set on Linux and Solaris boxs.
     // TODO WAVA      return "com.sun.java.swing.plaf.gtk.GTKLookAndFeel";
     // TODO WAVA  }
         // TODO WAVA if (osType == OSInfo.OSType.MACOSX) {
         // TODO WAVA     if (toolkit.getClass() .getName()
         // TODO WAVA                             .equals("wava.sun.lwawt.macosx.LWCToolkit")) {
         // TODO WAVA          return "com.apple.laf.AquaLookAndFeel";
         // TODO WAVA     }
         // TODO WAVA }
         // TODO WAVA  if (osType == OSInfo.OSType.SOLARIS) {
         // TODO WAVA      return "com.sun.java.swing.plaf.motif.MotifLookAndFeel";
         // TODO WAVA   }
         // TODO WAVA }
        ...
        if (UIManager.class.getClassLoader() != null) {
            ...
            java.security.AccessController.doPrivileged(
                ...
                public Object run() {
                 // TODO WAVA  OSInfo.OSType osType = AccessController.doPrivileged(OSInfo.getOSTypeAction());
                 // TODO WAVA  if (osType == OSInfo.OSType.MACOSX) {
                 // TODO WAVA      props.put(defaultLAFKey, getSystemLookAndFeelClassName());
                 // TODO WAVA  }
    ...
    private static void initialize() {
        ...
        if (RepaintManager.HANDLE_TOP_LEVEL_PAINT) {
            wava.sun.awt.PaintEventDispatcher.setPaintEventDispatcher(
