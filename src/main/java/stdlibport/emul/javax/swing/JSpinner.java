...
// TODO WAVA import wava.sun.util.locale.provider.LocaleProviderAdapter;
// TODO WAVA import wava.sun.util.locale.provider.LocaleResources;
...
public class JSpinner extends JComponent implements Accessible
{
    ...
    public static class DateEditor extends DefaultEditor
    {
        ...
        private static String getDefaultPattern(Locale loc) {
            // TODO WAVA LocaleProviderAdapter adapter = LocaleProviderAdapter.getAdapter(DateFormatProvider.class, loc);
            // TODO WAVA LocaleResources lr = adapter.getLocaleResources(loc);
            // TODO WAVA if (lr == null) {
            // TODO WAVA     lr = LocaleProviderAdapter.forJRE().getLocaleResources(loc);
            // TODO WAVA }
            // TODO WAVA return lr.getDateTimePattern(DateFormat.SHORT, DateFormat.SHORT, null);
            return "WAVA_DEBUG";
        }
    ...
    public static class NumberEditor extends DefaultEditor
    {
        ...
        private static String getDefaultPattern(Locale locale) {
            ...
            // TODO WAVA LocaleProviderAdapter adapter;
            // TODO WAVA adapter = LocaleProviderAdapter.getAdapter(NumberFormatProvider.class,
            // TODO WAVA                                            locale);
            // TODO WAVA LocaleResources lr = adapter.getLocaleResources(locale);
            // TODO WAVA if (lr == null) {
            // TODO WAVA     lr = LocaleProviderAdapter.forJRE().getLocaleResources(locale);
            // TODO WAVA }
            // TODO WAVA String[] all = lr.getNumberPatterns();
            return null;
        }
