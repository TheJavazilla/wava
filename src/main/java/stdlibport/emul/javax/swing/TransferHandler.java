...
// TODO WAVA import wava.sun.reflect.misc.MethodUtil;
import wava.sun.swing.SwingUtilities2;
import wava.sun.awt.AppContext;
import wava.sun.swing.*;
...
//TODO WAVA import wava.sun.misc.SharedSecrets;
//TODO WAVA import wava.sun.misc.JavaSecurityAccess;
...
public class TransferHandler implements Serializable {
        ...
        if (prop != null) {
            ...
            if (flavor != null) {
                try {
                    ...
                    Object[] args = { value };
                 // TODO WAVA MethodUtil.invoke(writer, comp, args);
                    return true;
                } catch (Exception ex) {
    ...
    static class PropertyTransferable implements Transferable {
        ...
        public Object getTransferData(DataFlavor flavor) throws UnsupportedFlavorException, IOException {
            ...
            Object value = null;
            try {
             // TODO WAVA value = MethodUtil.invoke(reader, component, (Object[])null);
            } catch (Exception ex) {
    ...
    static class TransferAction extends UIAction implements UIResource {
     ...
     // TODO WAVA private static final JavaSecurityAccess javaSecurityAccess =
     // TODO WAVA     SharedSecrets.getJavaSecurityAccess();
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            actionPerformedImpl(e); // TODO WAVA 
                if (srcAcc == null) {
                 // TODO WAVA javaSecurityAccess.doIntersectionPrivilege(action, stack, eventAcc);
                } else {
                 // TODO WAVA javaSecurityAccess.doIntersectionPrivilege(
                 // TODO WAVA  new PrivilegedAction<Void>() {
                 // TODO WAVA  public Void run() {
                 // TODO WAVA  javaSecurityAccess.doIntersectionPrivilege(action, eventAcc);
                 // TODO WAVA   return null;
                 // TODO WAVA }
                 // TODO WAVA }, stack, srcAcc);
                }
        }
        ...
        private Clipboard getClipboard(JComponent c) {
            ...
            Clipboard clipboard = (Clipboard)wava.sun.awt.AppContext.getAppContext().
                get(SandboxClipboardKey);
            if (clipboard == null) {
                clipboard = new Clipboard("Sandboxed Component Clipboard");
                wava.sun.awt.AppContext.getAppContext().put(SandboxClipboardKey,
                                                       clipboard);
            }
            return clipboard;
        }
