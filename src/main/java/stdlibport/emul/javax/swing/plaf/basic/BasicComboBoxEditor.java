    ...
    public Object getItem() {
        ...
        if (oldValue != null && !(oldValue instanceof String))  {
            ...
            if (newValue.equals(oldValue.toString()))  {
                ...
                try {
                 // TODO WAVA Method method = MethodUtil.getMethod(cls, "valueOf", new Class[]{String.class});
                 // TODO WAVA  newValue = MethodUtil.invoke(method, oldValue, new Object[] { editor.getText()});
                } catch (Exception ex) {
