...
import wava.sun.swing.DefaultLookup;
import wava.sun.swing.UIAction;
    ...
    static class MouseGrabber implements ChangeListener,
        ...
        void grabWindow(MenuElement[] newPath) {
                ...
                new java.security.PrivilegedAction<Object>() {
                    public Object run() {
                        tk.addAWTEventListener(MouseGrabber.this,
                                ...
                                AWTEvent.WINDOW_EVENT_MASK | wava.sun.awt.SunToolkit.GRAB_EVENT_MASK);
                        return null;
                    }
                }
            );
            ...
            if(grabbedWindow != null) {
                if(tk instanceof wava.sun.awt.SunToolkit) {
                    ((wava.sun.awt.SunToolkit)tk).grab(grabbedWindow);
                } else {
        ...
        void realUngrabWindow() {
            ...
            if(grabbedWindow != null) {
                if(tk instanceof wava.sun.awt.SunToolkit) {
                    ((wava.sun.awt.SunToolkit)tk).ungrab(grabbedWindow);
                } else {
        ...
        public void eventDispatched(AWTEvent ev) {
            if(ev instanceof wava.sun.awt.UngrabEvent) {
