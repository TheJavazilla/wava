...
// TODO WAVA import com.sun.awt.AWTUtilities;
...
public class DefaultDesktopManager implements DesktopManager, java.io.Serializable {
    ...
    private void setupDragMode(JComponent f) {
        ...
        if (p != null) {
            ...
            if (window != null /*&& !AWTUtilities.isWindowOpaque(window)*/) { // TODO WAVA
                dragMode = DEFAULT_DRAG_MODE;
    ...
    public void dragFrame(JComponent f, int newX, int newY) {
        ...
        if (dragMode == OUTLINE_DRAG_MODE) {
            ...
            if (desktopPane != null){
              ...
              */
              wava.sun.java2d.SurfaceData sData =
                  ((wava.sun.java2d.SunGraphics2D)g).getSurfaceData();
