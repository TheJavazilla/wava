...
//import wava.sun.awt.HeadlessToolkit;
...
public class SystemTray {
    ...
    public static boolean isSupported() {
        ...
        // TODO WAVA } else if (toolkit instanceof HeadlessToolkit) {
            // skip initialization as the init routine
            // throws HeadlessException
         // TODO WAVA return ((HeadlessToolkit)toolkit).isTraySupported();
        } else {
            return false;
        }
    }
    ...
    synchronized void addNotify() {
        if (peer == null) {
            ...
            if (toolkit instanceof SunToolkit) {
             ...
             // TODO WAVA} else if (toolkit instanceof HeadlessToolkit) {
             // TODO WAVA    peer = ((HeadlessToolkit)Toolkit.getDefaultToolkit()).createSystemTray(this);
            }
        }
    }
