...
import wava.sun.java2d.StateTrackableDelegate;

import wava.sun.awt.image.SunWritableRaster;
...
public abstract class DataBuffer {
    ...
    /** Returns the size (in bits) of the data type, given a datatype tag.
      ...
      * @throws IllegalArgumentException if <code>type</code> is less than zero or greater than {@link #TYPE_DOUBLE}
      */
     ...
     *  offset for each bank is specified by its respective entry in the offsets array.
     *
     *  @param dataType the data type of this <code>DataBuffer</code>
     *  @param size the size of the banks
     *  @param numBanks the number of banks in this <code>DataBuffer</code>
     *  @param offsets an array containing an offset for each bank.
     *  @throws ArrayIndexOutOfBoundsException if <code>numBanks</code> does not equal the length of <code>offsets</code>
     */
     ...
     *  Constructs a DataBuffer which contains the specified number
     *  of banks with the indicated initial {@link State State}.
     *  Each bank has the specified datatype and size. The offset for
     *  each bank is specified by its respective entry in the offsets array.
     *
     *  @param initialState the initial {@link State State} state of the data
     *  @param dataType the data type of this <code>DataBuffer</code>
     *  @param size the size of the banks
    ...
    DataBuffer(State initialState, int dataType, int size, int numBanks, int offsets[]) {
        ...
        this.offsets = (int[])wava.helpers.Cloner.clone(offsets);
    }
    ...
    public int[] getOffsets() {
        return (int[])wava.helpers.Cloner.clone(offsets);
    }
     ...
     * @param i the index of the requested data array element
     * @return the data array element at the specified index from the specified bank at the specified index.
     * @see #setElem(int, int)
     * @see #setElem(int, int, int)
     */
     ...
     * @param i the index of the requested data array element
     * @return a float value representing the data array element at the specified index.
     ...
     * @param bank the specified bank
     * @param i the index of the requested data array element
     * @return a float value representing the data array element from the specified bank at the specified index.
     * @see #setElemFloat(int, float)
     * @see #setElemFloat(int, int, float)
     */
     ...
     * @param bank the specified bank
     * @param i the specified index
     * @param val the value to set the element in the specified bank at the specified index in the data array
     * @see #getElemFloat(int)
     * @see #getElemFloat(int, int)
     */
     ...
     * The implementation in this class is to cast {@link #getElem(int)} to a double.
     ...
     * @param bank the specified bank
     * @param i the specified index
     * @return a double value representing the element from the specified bank at the specified index in the data array.
     * @see #setElemDouble(int, double)
     * @see #setElemDouble(int, int, double)
     */
     ...
     * @param bank the specified bank
     * @param i the specified index
     * @param val the value to set the element in the specified bank at the specified index of the data array
     * @see #getElemDouble(int)
     * @see #getElemDouble(int, int)
     */
