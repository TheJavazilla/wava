...
public class RenderContext implements Cloneable {
    ...
    public RenderContext(AffineTransform usr2dev,
        ...
        this.hints = hints;
        this.aoi = aoi;
        this.usr2dev = (AffineTransform)wava.helpers.Cloner.clone( usr2dev );
    }
    ...
    public void setTransform(AffineTransform newTransform) {
        usr2dev = (AffineTransform)wava.helpers.Cloner.clone( newTransform );
    }
    ...
    public AffineTransform getTransform() {
        return (AffineTransform)wava.helpers.Cloner.clone( usr2dev );
    }
