...
public class ComponentSampleModel extends SampleModel
{
    ...
    public ComponentSampleModel(int dataType, int w, int h, int pixelStride, int scanlineStride, int bandOffsets[]) {
        ...
        this.bandOffsets = (int[])wava.helpers.Cloner.clone(bandOffsets);
    ...
    public ComponentSampleModel(int dataType, int w, int h, int pixelStride, int scanlineStride, int bankIndices[], int bandOffsets[]) {
        ...
        this.scanlineStride  = scanlineStride;
        this.bandOffsets = (int[])wava.helpers.Cloner.clone(bandOffsets);
        this.bankIndices = (int[])wava.helpers.Cloner.clone(bankIndices);
        if (pixelStride < 0) {
            throw new IllegalArgumentException("Pixel stride must be >= 0");
        }
        // TODO - bug 4296691 - remove this check
    ...
    public final int [] getBankIndices() {
        return (int[]) wava.helpers.Cloner.clone(bankIndices);
    }
    ...
    public final int [] getBandOffsets() {
        return (int[])wava.helpers.Cloner.clone(bandOffsets);
    }
