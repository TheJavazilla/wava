...
// TODO WAVA import wava.sun.awt.HeadlessToolkit;
import wava.sun.awt.NullComponentPeer;
import wava.sun.awt.PeerEvent;
...
public abstract class Toolkit {
                ...
                public Void run() {
                    ...
                    try {
                        if (cls != null) {
                         ...
                         // TODO WAVAif (GraphicsEnvironment.isHeadless()) {
                         // TODO WAVA    toolkit = new HeadlessToolkit(toolkit);
                         // TODO WAVA}
                        }
    ...
    static {
        ...
        java.security.AccessController.doPrivileged(
            ...
            public Void run() {
                try {
                    resources = ResourceBundle.getBundle("sun.awt.resources.awt", Locale.getDefault(), ClassLoader.getSystemClassLoader(),
                            null/*CoreResourceBundleControl.getRBControlInstance()*/);
    ...
    */
    ...
    public final synchronized Object getDesktopProperty(String propertyName) {
        ...
        // --mm, 03/03/00
        // TODO WAVA if (this instanceof HeadlessToolkit) {
        // TODO WAVA     return ((HeadlessToolkit)this).getUnderlyingToolkit()
        // TODO WAVA         .getDesktopProperty(propertyName);
        // TODO WAVA }
    ...
    protected final void setDesktopProperty(String name, Object newValue) {
        ...
        // --mm, 03/03/00
        // TODO WAVA if (this instanceof HeadlessToolkit) {
        // TODO WAVA     ((HeadlessToolkit)this).getUnderlyingToolkit()
        // TODO WAVA         .setDesktopProperty(name, newValue);
        // TODO WAVA     return;
        // TODO WAVA }
        Object oldValue;
    ...
    void notifyAWTEventListeners(AWTEvent theEvent) {
        ...
        // TODO WAVA if (this instanceof HeadlessToolkit) {
        // TODO WAVA     ((HeadlessToolkit)this).getUnderlyingToolkit()
        // TODO WAVA         .notifyAWTEventListeners(theEvent);
        // TODO WAVA     return;
        // TODO WAVA }
        ...
        public void eventDispatched(AWTEvent event) {
            ...
            if (((eventBit = eventMask & AWTEvent.COMPONENT_EVENT_MASK) != 0 &&
             ...
             || ((eventBit = eventMask & AWTEvent.WINDOW_FOCUS_EVENT_MASK) != 0 &&
                ...
                || ((eventBit = eventMask & wava.sun.awt.SunToolkit.GRAB_EVENT_MASK) != 0 &&
                    (event instanceof wava.sun.awt.UngrabEvent))) {
    ...
    private static PropertyChangeSupport createPropertyChangeSupport(Toolkit toolkit) {
        if (toolkit instanceof SunToolkit) {  // TODO WAVA || toolkit instanceof HeadlessToolkit) {
