...
import wava.sun.awt.AWTAccessor.MouseEventAccessor;
...
public class Container extends Component {
    ...
    public Insets insets() {
        ...
        if (peer instanceof ContainerPeer) {
            ...
            return wava.helpers.Cloner.clone( (Insets)cpeer.getInsets() );
        }
    ...
    static {
        ...
        isJavaAwtSmartInvalidate = false;//AccessController.doPrivileged(new GetBooleanAction("java.awt.smartInvalidate"));
    }
    ...
    public Component locate(int x, int y) {
        ...
        synchronized (getTreeLock()) {
            ...
            // see comment in wava.sun.awt.SunGraphicsCallback
     ...
     * lightweight cursor support in wava.sun.awt.GlobalCursorManager.
     *
