...
import wava.sun.awt.dnd.SunDragSourceContextPeer;
// TODO WAVA import wava.sun.security.action.GetIntegerAction;
...
public class DragSource implements Serializable {
    ...
    public static int getDragThreshold() {
        int ts = 0;// TODO WAVA AccessController.doPrivileged(new GetIntegerAction("awt.dnd.drag.threshold", 0)).intValue();
        if (ts > 0) {
            return ts;
        } else {
