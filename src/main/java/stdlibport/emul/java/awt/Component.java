...
// TODO WAVA import wava.sun.security.action.GetPropertyAction;
import wava.sun.awt.AppContext;
import wava.sun.awt.AWTAccessor;
import wava.sun.awt.ConstrainableGraphics;
import wava.sun.awt.SubRegionShowable;
import wava.sun.awt.SunToolkit;
import wava.sun.awt.WindowClosingListener;
import wava.sun.awt.CausedFocusEvent;
import wava.sun.awt.EmbeddedFrame;
import wava.sun.awt.dnd.SunDropTargetEvent;
import wava.sun.awt.im.CompositionArea;
import wava.sun.font.FontManager;
import wava.sun.font.FontManagerFactory;
import wava.sun.font.SunFontManager;
import wava.sun.java2d.SunGraphics2D;
import wava.sun.java2d.pipe.Region;
import wava.sun.awt.image.VSyncedBSManager;
import wava.sun.java2d.pipe.hw.ExtendedBufferCapabilities;
import static wava.sun.java2d.pipe.hw.ExtendedBufferCapabilities.VSyncType.*;
import wava.sun.awt.RequestFocusController;
import wava.sun.java2d.SunGraphicsEnvironment;
...
public abstract class Component implements ImageObserver, MenuContainer, Serializable {
    ...
    /**
     * The parent of the object. It may be <code>null</code> for top-level components.
     * @see #getParent
     */
    transient Container parent;

    /**
     * The <code>AppContext</code> of the component. Applets/Plugin may change the AppContext.
     */
    ...
    static {
        ...
        String s = "true";//java.security.AccessController.doPrivileged(new GetPropertyAction("awt.image.incrementaldraw"));
        isInc = (s == null || s.equals("true"));

        s = "100";//java.security.AccessController.doPrivileged(new GetPropertyAction("awt.image.redrawrate"));
    ...
    /**
     * Constructs a name for this component. Called by <code>getName</code> when the name is null.
     */
     ...
     *          until a toplevel window or null parent are visible, <code>false</code> otherwise
     */
    ...
    private Rectangle getRecursivelyVisibleBounds() {
        ...
        if (container == null)
            return bounds;// we are top level window or haven't a container, return our bounds
    ...
    public Point getMousePosition() throws HeadlessException {
        ...
        PointerInfo pi = java.security.AccessController.doPrivileged(new java.security.PrivilegedAction<PointerInfo>() {public PointerInfo run() {return MouseInfo.getPointerInfo();}});
    ...
    /**
     * @deprecated replaced by <code>setVisible(boolean)</code>.
     */
    @Deprecated
    public void show() {
        if (!visible) {
    ...
    void clearCurrentFocusCycleRootOnHide() {/* do nothing */}
    ...
    public void setForeground(Color c) {
        ...
        // This is a bound property, so report the change to any registered listeners. (Cheap if there are none.)
     ...
     *
     * @return <code>true</code> if the foreground color has been explicitly set for this Component; <code>false</code> otherwise.
     */
     ...
     * @return this component's background color; if this component does not have a background color,
    ...
    public void setFont(Font f) {
        ...
        // This could change the preferred size of the Component. Fix for 6213660.
        // Should compare old and new fonts and do not call invalidate() if they are equal.
    ...
    /**
     * Returns whether the font has been explicitly set for this Component. If this method
     * returns <code>false</code>, this Component is inheriting its font from an ancestor.
     *
     * @return <code>true</code> if the font has been explicitly set for this Component; <code>false</code> otherwise.
     */
     ...
     * @see #setLocale
     * @exception IllegalComponentStateException if the <code>Component</code> does not have its own locale and has not yet been added to
     *          a containment hierarchy such that the locale can be determined from the containing parent
     */
     ...
     * component.</p>
     * @return an instance of <code>Point</code> representing the top-left corner of the
     *         component's bounds in the coordinate space of the component's parent
     * @see #setLocation
     ...
     *
     * @return an instance of <code>Point</code> representing the top-left corner of the component's bounds in the coordinate space of the screen
     * @throws IllegalComponentStateException if the component is not showing on the screen
     * @see #setLocation
     * @see #getLocation
     */
    ...
    final Point getLocationOnScreen_NoTreeLock() {
        ...
        } else throw new IllegalComponentStateException("component must be showing on the screen to determine its location");
    }


    /**
     * @deprecated replaced by <code>getLocation()</code>.
     */
    @Deprecated
    ...
    /**
     * @deprecated replaced by <code>setLocation(int, int)</code>.
     */
    @Deprecated
    ...
    /**
     * @deprecated replaced by <code>getSize()</code>.
     */
    @Deprecated
    ...
    /**
     * @deprecated replaced by <code>setSize(int, int)</code>.
     */
    @Deprecated
    ...
    /**
     * @deprecated replaced by <code>setSize(Dimension)</code>.
     */
    @Deprecated
    ...
    /**
     * @deprecated replaced by <code>getBounds()</code>.
     */
    @Deprecated
    ...
    /**
     * Moves and resizes this component. The new location of the top-left corner is specified by <code>x</code>
     * and <code>y</code>, and the new size is specified by <code>width</code> and <code>height</code>.
     * <p>
    ...
    /**
     * @deprecated replaced by <code>setBounds(int, int, int, int)</code>.
     */
    @Deprecated
    ...
    private void reshapeNativePeer(int x, int y, int width, int height, int op) {
        // native peer might be offset by more than direct parent since parent might be lightweight.
        int nativeX = x;
        int nativeY = y;
     ...
     * This component's new position is specified by <code>r.x</code> and <code>r.y</code>,
     * and its new size is specified by <code>r.width</code> and <code>r.height</code>
     * <p>This method changes layout-related information, and therefore,* invalidates the component hierarchy.
     *
     ...
     * or <code>component.getLocation().x</code> because it doesn't cause any heap allocations.
     *
     ...
     * This method is preferable to writing <code>component.getBounds().y</code>,
     * or <code>component.getLocation().y</code> because it doesn't cause any heap allocations.
     *
    ...
    public FontMetrics getFontMetrics(Font font) {
        ...
        return wava.sun.font.FontDesignMetrics.getMetrics(font);
    }
    ...
    private Insets getInsets_NoClientCode() {
        ...
        if (peer instanceof ContainerPeer) {
            return wava.helpers.Cloner.clone((Insets)((ContainerPeer)peer).getInsets());
        }
    ...
    void createBufferStrategy(int numBuffers) {
        ...
        try {
            ...
            // TODO WAVA throw new InternalError("Could not create a buffer strategy", e);
        }
    }
     ...
     *
     * @see wava.sun.java2d.SunGraphicsEnvironment#isFlipStrategyPreferred(ComponentPeer)
     */
    ...
    protected class BltBufferStrategy extends BufferStrategy {
        ...
        public Graphics getDrawGraphics() {
            ...
            WebGraphics g = (WebGraphics) backBuffer.getGraphics();
    ...
    void dispatchEventImpl(AWTEvent e) {
        ...
        if (areInputMethodsEnabled()) {
            ...
            if (id == FocusEvent.FOCUS_GAINED) {
                InputContext inputContext = getInputContext();
                // TODO WAVA if (inputContext != null && inputContext instanceof wava.sun.awt.im.InputContext) {
                //    ((wava.sun.awt.im.InputContext)inputContext).disableNativeIM();
                //}
            }
        }
        ...
        switch(id) {
            ...
            // - Fred.Ecks@Eng.wava.sun.com, 5-8-98
    ...
    transient wava.sun.awt.EventQueueItem[] eventCache;
    ...
    final boolean requestFocusHelper(boolean temporary,boolean focusedWindowChangeAllowed, CausedFocusEvent.Cause cause) {
        ...
        boolean success = false;//peer.requestFocus(this, temporary, focusedWindowChangeAllowed, time, cause);
        if (!success) {
    ...
    final boolean isMixingNeeded() {
        if (SunToolkit.getSunAwtDisableMixing()) {
            ...
            //    mixingLog.finest("this = " + this + "; Mixing disabled via wava.sun.awt.disableMixing");
           // }
            return false;
        }
        if (!areBoundsValid()) {
