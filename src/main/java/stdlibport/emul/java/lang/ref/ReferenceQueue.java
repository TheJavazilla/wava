...
public class ReferenceQueue<T> {
    ...
    private static class Null<S> extends ReferenceQueue<S> {
        boolean enqueue(Reference<? extends S> r) {return false;}
    }
    ...
    public Reference<? extends T> poll() {
        ...
        synchronized (lock) {return reallyPoll();}
    }
        ...
        for (Reference<? extends T> r = head; r != null;) {
            ...
            if (rn == r) {
                if (r.queue == ENQUEUED) {
                    ...
                    r = null;
                } else r = head;// already dequeued: r.queue == NULL; -> restart from head when overtaken by queue poller(s)
            } else r = rn;// next in chain
        }
    }
