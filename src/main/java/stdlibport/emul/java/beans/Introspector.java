 ...
 * path.
 * <p>
 * Thus for a class such as "wava.sun.xyz.OurButton" we would first look for a
 * BeanInfo class called "wava.sun.xyz.OurButtonBeanInfo" and if that failed we'd
 * look in each package in the BeanInfo search path for an OurButtonBeanInfo
 * class.  With the default search path, this would mean looking for
 * "wava.sun.beans.infos.OurButtonBeanInfo".
 * <p>
...
public class Introspector {
     ...
     *          Sun implementation initially sets to {"wava.sun.beans.infos"}.
     */
