...
import wava.sun.swing.PrintColorUIResource;
import wava.sun.swing.ImageIconUIResource;
// TODO import wava.sun.print.ProxyPrintGraphics;
import wava.sun.awt.*;
import wava.sun.security.action.GetPropertyAction;
// TODO import wava.sun.security.util.SecurityConstants;
import java.io.*;
import java.util.*;
...
public class SwingUtilities2 {
    ...
    public static Graphics2D getGraphics2D(Graphics g) {
        if (g instanceof Graphics2D) {
            return (Graphics2D) g;
        // TODO WAVA } else if (g instanceof ProxyPrintGraphics) {
        // TODO WAVA    return (Graphics2D)(((ProxyPrintGraphics)g).getGraphics());
        } else {
            return null;
        }
    }
     ...
     * or com.wava.sun.java.swing.plaf.windows.WindowsTextUI) and its background color
    ...
    public static boolean useSelectedTextColor(Highlighter.Highlight h, JTextComponent c) {
        ...
        if (painterClass.indexOf("javax.swing.text.DefaultHighlighter") != 0 &&
                painterClass.indexOf("com.wava.sun.java.swing.plaf.windows.WindowsTextUI") != 0) {
            return false;
        }
        try {
