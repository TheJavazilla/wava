...
import wava.sun.awt.LightweightFrame;
// TODO WAVA import wava.sun.awt.OverrideNativeWindowHandle;
...
public final class JLightweightFrame extends LightweightFrame implements RootPaneContainer {
    ...
    public void overrideNativeWindowHandle(long handle, Runnable closeWindow) {
        ...
        // TODO WAVA if (peer instanceof OverrideNativeWindowHandle) {
        // TODO WAVA    ((OverrideNativeWindowHandle) peer).overrideWindowHandle(handle);
        // TODO WAVA }
        if (closeWindow != null) {
            closeWindow.run();
        }
