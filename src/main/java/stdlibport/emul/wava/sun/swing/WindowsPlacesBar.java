...
public class WindowsPlacesBar extends JToolBar
    ...
    public WindowsPlacesBar(JFileChooser fc, boolean isXPStyle) {
        ...
        // TODO WAVA boolean isXPPlatform = (OSInfo.getOSType() == OSInfo.OSType.WINDOWS &&
        // TODO WAVA        OSInfo.getWindowsVersion().compareTo(OSInfo.WINDOWS_XP) >= 0);
        boolean isXPPlatform = false;
