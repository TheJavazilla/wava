...
import wava.sun.awt.image.PixelConverter;
...
import static wava.sun.java2d.pipe.BufferedOpCodes.*;
...
/************************* GradientPaint support ****************************/
    ...
    private static void setGradientPaint(RenderQueue rq,
                                         ...
                                         boolean useMask)
    {
        setGradientPaint(rq, (AffineTransform)wava.helpers.Cloner.clone(sg2d.transform),
...
/************************** TexturePaint support ****************************/
                                        ...
                                        boolean useMask)
    {
        ...
        // calculate plane equation constants
        AffineTransform at = (AffineTransform)wava.helpers.Cloner.clone(sg2d.transform);
