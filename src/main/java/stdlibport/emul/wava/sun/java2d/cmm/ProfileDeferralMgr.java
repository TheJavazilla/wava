    ...
    public static void activateProfiles() {
        ...
        for (ProfileActivator pa : aVector) {
            try {
                 ...
                 * such exception is pssible due to absence or corruption of standard color profile.
                 * As for now we expect all profiles should be shiped with jre and presence of this
                 * exception is indication of some configuration problem in jre installation.
                 *
                 * NB: we still are greedy loading deferred profiles and load them all if any of them is needed. Therefore broken 
                 * profile (if any) might be never used. If there will be attempt to use broken profile then it will result in CMMException.
                 */
            }
        }
