...
import wava.sun.java2d.loops.DrawPolygons;
import wava.sun.java2d.loops.FillParallelogram;
import wava.sun.java2d.loops.DrawParallelogram;
...
public class LoopPipe implements PixelDrawPipe, PixelFillPipe, ParallelogramPipe, ShapeDrawPipe, LoopBasedPipe {
    ...
    private static void fillSpans(SunGraphics2D sg2d, SpanIterator si) {
        ...
        if (sg2d.clipState == SunGraphics2D.CLIP_SHAPE) {
            ...
            wava.sun.java2d.loops.FillSpans fs = sg2d.loops.fillSpansLoop;
            if (fs != null) {
