...
public abstract class SurfaceDataProxy implements DisplayChangedListener, SurfaceManager.FlushableCacheData {
    ...
    /*static {
        cachingAllowed = true;
        String manimg = AccessController.doPrivileged( new GetPropertyAction("wava.sun.java2d.managedimages"));
        ...
        defaultThreshold = 1;
        String num = AccessController.doPrivileged( new GetPropertyAction("wava.sun.java2d.accthreshold"));
        if (num != null) {
            try {
