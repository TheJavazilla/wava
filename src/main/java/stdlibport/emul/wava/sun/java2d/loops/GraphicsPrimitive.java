...
import wava.sun.awt.image.BufImgSurfaceData;
...
public abstract class GraphicsPrimitive {
    ...
    **/
    ...
    static {
        // TODO WAVA
        /*GetPropertyAction gpa = new GetPropertyAction("wava.sun.java2d.trace");
        ...
        if (trace != null) {
            ...
            while (st.hasMoreTokens()) {
                ...
                if (tok.equalsIgnoreCase("count")) {
                    ...
                    System.err.println("usage: -Dwava.sun.java2d.trace="+
                                       "[log[,timestamp]],[count],"+
