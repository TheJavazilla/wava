...
import wava.sun.awt.image.SurfaceManager;
import wava.sun.font.FontDesignMetrics;
import wava.sun.font.FontUtilities;
import wava.sun.java2d.pipe.PixelDrawPipe;
import wava.sun.java2d.pipe.PixelFillPipe;
import wava.sun.java2d.pipe.ShapeDrawPipe;
import wava.sun.java2d.pipe.ValidatePipe;
import wava.sun.java2d.pipe.ShapeSpanIterator;
import wava.sun.java2d.pipe.Region;
import wava.sun.java2d.pipe.TextPipe;
import wava.sun.java2d.pipe.DrawImagePipe;
import wava.sun.java2d.pipe.LoopPipe;
import wava.sun.java2d.loops.FontInfo;
import wava.sun.java2d.loops.RenderLoops;
import wava.sun.java2d.loops.CompositeType;
import wava.sun.java2d.loops.SurfaceType;
import wava.sun.java2d.loops.Blit;
import wava.sun.java2d.loops.MaskFill;
import java.awt.font.FontRenderContext;
import wava.sun.java2d.loops.XORComposite;
import wava.sun.awt.ConstrainableGraphics;
import wava.sun.awt.SunHints;
import java.util.Map;

import com.google.gwt.canvas.dom.client.Context2d;

import java.util.Iterator;
//import wava.sun.misc.PerformanceLogger;

import java.lang.annotation.Native;
import wava.sun.awt.image.MultiResolutionImage;

import static java.awt.geom.AffineTransform.TYPE_FLIP;
import static java.awt.geom.AffineTransform.TYPE_MASK_SCALE;
import static java.awt.geom.AffineTransform.TYPE_TRANSLATION;
import wava.sun.awt.image.MultiResolutionToolkitImage;
import wava.sun.awt.image.ToolkitImage;
...
public final class SunGraphics2D extends Graphics2D implements ConstrainableGraphics, Cloneable/*, DestSurfaceProvider*/ {
    ...
    @Native
    public static final int COMP_ISCOPY = 0;/* simple stores into destination, i.e. Src, SrcOverNoEa, and other alpha modes which replace the destination.*/
...
//                    paintState > PAINT_ALPHACOLOR
    ...
    public static final double MinPenSizeAA =
        wava.sun.java2d.pipe.RenderingEngine.getInstance().getMinimumAAPenSize();
    ...
    */
    ...
    public void drawRenderedImage(RenderedImage img,
        ...
        AffineTransform transXform = (AffineTransform)wava.helpers.Cloner.clone(xform);
