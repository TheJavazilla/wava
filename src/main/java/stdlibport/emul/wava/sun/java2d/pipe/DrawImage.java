...
import wava.sun.awt.image.ImageRepresentation;
import wava.sun.awt.image.SurfaceManager;
import wava.sun.awt.image.ToolkitImage;
import wava.sun.java2d.InvalidPipeException;
import wava.sun.java2d.SunGraphics2D;
import wava.sun.java2d.SurfaceData;
import wava.sun.java2d.loops.Blit;
import wava.sun.java2d.loops.BlitBg;
import wava.sun.java2d.loops.TransformHelper;
import wava.sun.java2d.loops.MaskBlit;
import wava.sun.java2d.loops.CompositeType;
import wava.sun.java2d.loops.ScaledBlit;
        ...
        if (sg.renderHint != SunHints.INTVAL_RENDER_QUALITY) {
            if (cm instanceof IndexColorModel) {
                ...
                if (needTrans && cm.getTransparency() == Transparency.OPAQUE) {
                    // Fix 4221407
                    if (raster instanceof wava.sun.awt.image.BytePackedRaster) {
                    ...
                    }   /* raster instanceof wava.sun.awt.image.BytePackedRaster */
