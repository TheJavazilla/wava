...
public final class MethodUtil extends SecureClassLoader {
    ...
    public static Method getMethod(Class<?> cls, String name, Class<?>[] args)
     ...
     // TODO WAVA ReflectUtil.checkPackageAccess(cls);
    ...
    private static boolean getInternalPublicMethods(Class<?> cls,
        ...
        try {
         ...
         // TODO WAVA if (!ReflectUtil.isPackageAccessible(cls)) {
         // TODO WAVA     return false;
         // TODO WAVA }
        ...
        throws ClassNotFoundException
    {
        ...
        // TODO WAVA ReflectUtil.checkPackageAccess(name);
