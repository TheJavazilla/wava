/*
 * Copyright (c) 2020, Fungus Software and/or its affiliates.
...
public abstract class SunToolkit extends Toolkit
    ...
    //static {
        ...
        //    AccessController.doPrivileged(new GetPropertyAction("awt.touchKeyboardAutoShowIsEnabled", "true")));
    //};
    ...
    public static boolean getSunAwtNoerasebackground() {
        return false;// TODO WAVA return AccessController.doPrivileged(new GetBooleanAction("sun.awt.noerasebackground"));
    }
    ...
    public static boolean getSunAwtErasebackgroundonresize() {
        return false;// TODO WAVA return AccessController.doPrivileged(new GetBooleanAction("sun.awt.erasebackgroundonresize"));
    }
    ...
    public Window createInputMethodWindow(String title, InputContext context) {
        return new wava.sun.awt.im.SimpleInputMethodWindow(title, context);
    }
    ...
    public static Locale getStartupLocale() {
        if (startupLocale == null) {
            ...
            language = "en"; // TODO WAVA AccessController.doPrivileged(new GetPropertyAction("user.language", "en"));
    ...
    public static boolean needsXEmbed() {
        String noxembed = "false"; // TODO WAVA AccessController.doPrivileged(new GetPropertyAction("sun.awt.noxembed", "false"));
    ...
    protected final boolean isXEmbedServerRequested() {
        return false;// TODO WAVA return AccessController.doPrivileged(new GetBooleanAction("sun.awt.xembedserver"));
    }
    ...
    public synchronized static boolean getSunAwtDisableMixing() {
        if (sunAwtDisableMixing == null) {
            sunAwtDisableMixing = false;// TODO WAVA AccessController.doPrivileged(new GetBooleanAction("sun.awt.disableMixing"));
        }
