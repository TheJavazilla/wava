...
//import wava.sun.nio.cs.HistoricallyNamedCharset;
...
public class FontDescriptor implements Cloneable {
    ...
    static boolean isLE;
    static {
        //String enc = (String) java.security.AccessController.doPrivileged( new wava.sun.security.action.GetPropertyAction("wava.sun.io.unicode.encoding", "UnicodeBig"));
        isLE = false;//!"UnicodeBig".equals(enc);
    }
}
