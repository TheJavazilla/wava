...
import wava.sun.awt.InputMethodSupport;
...
public class InputMethodContext extends wava.sun.awt.im.InputContext implements java.awt.im.spi.InputMethodContext {
    ...
    static {
        ...
        //String inputStyle = "none";//AccessController.doPrivileged (new GetPropertyAction("java.awt.im.style", null));
        // get property from awt.properties file
        //if (inputStyle == null)
        //    inputStyle = Toolkit.getProperty("java.awt.im.style", null);

        belowTheSpotInputRequested = false;//"below-the-spot".equals(inputStyle);
    }
