...
// TODO WAVA import sun.awt.OSInfo;
// TODO WAVA import wava.sun.misc.ThreadGroupUtils;
import wava.sun.util.logging.PlatformLogger;

import static wava.sun.awt.shell.Win32ShellFolder2.DESKTOP;
import static wava.sun.awt.shell.Win32ShellFolder2.DRIVES;
import static wava.sun.awt.shell.Win32ShellFolder2.Invoker;
import static wava.sun.awt.shell.Win32ShellFolder2.NETWORK;
import static wava.sun.awt.shell.Win32ShellFolder2.PERSONAL;
import static wava.sun.awt.shell.Win32ShellFolder2.RECENT;
    ...
    public Object get(String key) {
        if (key.equals("fileChooserDefaultFolder")) {
            ...
            if (desktop != null && checkFile(desktop) != null) {
                ...
                // TODO WAVA    folders.add(recentFolder);
                //}
    ...
    private static class ComInvoker extends ThreadPoolExecutor implements ThreadFactory, ShellFolder.Invoker {
        ...
        public synchronized Thread newThread(final Runnable task) {
            ...
            comThread =  AccessController.doPrivileged((PrivilegedAction<Thread>) () -> {
                             ...
                             */
                            // TODO WAVA ThreadGroup rootTG = ThreadGroupUtils.getRootThreadGroup();
