...
import wava.sun.font.CompositeFontDescriptor;
...
public abstract class FontConfiguration {
    ...
    public FontConfiguration(SunFontManager fm) {
        ...
        if (FontUtilities.debugFonts() && logger == null) {
            logger = PlatformLogger.getLogger("wava.sun.awt.FontConfiguration");
        }
        fontManager = fm;
    ...
    private void findFontConfigFile() {
        ...
        String userConfigFile = System.getProperty("wava.sun.awt.fontconfig");
    ...
    */
    ...
    private CharsetEncoder getFontCharsetEncoder(final String charsetName,
        ...
        if (!charsetName.startsWith("wava.sun.awt.") && !charsetName.equals("default")) {
