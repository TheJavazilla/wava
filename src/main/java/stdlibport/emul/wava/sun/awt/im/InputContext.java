...
public class InputContext extends java.awt.im.InputContext implements ComponentListener, WindowListener {
    ...
    private static final PlatformLogger log = PlatformLogger.getLogger("wava.sun.awt.im.InputContext");
    ...
    private void focusGained(Component source) {
        ...
        synchronized (source.getTreeLock()) {
            synchronized (this) {
                if ("wava.sun.awt.im.CompositionArea".equals(source.getClass().getName())) {
    ...
    private void logCreationFailed(Throwable throwable) {
        PlatformLogger logger = PlatformLogger.getLogger("wava.sun.awt.im");
