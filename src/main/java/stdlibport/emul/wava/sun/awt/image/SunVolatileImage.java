...
import wava.sun.java2d.SurfaceManagerFactory;
// TODO WAVA import wava.sun.java2d.DestSurfaceProvider;
import wava.sun.java2d.Surface;
import static wava.sun.java2d.pipe.hw.AccelSurface.*;
...
public class SunVolatileImage extends VolatileImage /*implements DestSurfaceProvider*/ {
    ...
    protected VolatileSurfaceManager createSurfaceManager(Object context, ImageCapabilities caps) {
        ...
        if (graphicsConfig instanceof BufferedImageGraphicsConfig ||
            //graphicsConfig instanceof wava.sun.print.PrinterGraphicsConfig ||
     ...
     * {@inheritDoc}
     *
     * @see wava.sun.java2d.DestSurfaceProvider#getDestSurface
     */
    //@Override
