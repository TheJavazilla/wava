...
import wava.sun.awt.FontConfiguration;
import wava.sun.awt.SunToolkit;
// TODO: WAVA import wava.sun.misc.ThreadGroupUtils;
import wava.sun.java2d.FontSupport;
...
public abstract class SunFontManager implements FontSupport, FontManagerForSGE {
     ...
     * wava.sun.java2d.fontpath property. Together with that property,  it is
    ...
    static {
        ...
        java.security.AccessController.doPrivileged(
           ...
           public Object run() {
               ...
               noType1Font =
                   "true".equals(System.getProperty("wava.sun.java2d.noType1Font"));
               jreLibDirName =
        ...
        java.security.AccessController.doPrivileged(
                new java.security.PrivilegedAction() {
                    public Object run() {
                         ...
                         * -Dwava.sun.java2d.fontpath=append:/usr/local/myfonts
                         * and to prepend
                         * -Dwava.sun.java2d.fontpath=prepend:/usr/local/myfonts Disp
                         *
                         ...
                         * wava.sun.java2d.fontpath property is used, but it
                        ...
                        String dbgFontPath =
                            System.getProperty("wava.sun.java2d.fontpath");
...
//                new wava.sun.security.action.GetPropertyAction("file.encoding"));
...
//     }
     ...
     * wava.sun.font.FontManager.findFont2D is also updated to that it uses
    ...
    private static Locale getSystemStartupLocale() {
        if (systemLocale == null) {
            ...
            public Object run() {
                ...
                String sysEncoding = System.getProperty("wava.sun.jnu.encoding");
