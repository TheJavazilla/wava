    ...
    static {
        ...
        AccessController.doPrivileged(new PrivilegedAction () {
            public Object run() {
                ...
                String t2kStr = System.getProperty("wava.sun.java2d.font.scaler");
                if (t2kStr != null) {
                ...
                String debugLevel =
                    System.getProperty("wava.sun.java2d.debugfonts");

                if (debugLevel != null && !debugLevel.equals("false")) {
                    debugFonts = true;
                    logger = PlatformLogger.getLogger("wava.sun.java2d");
