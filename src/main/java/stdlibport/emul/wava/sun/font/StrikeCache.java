...
import wava.sun.java2d.pipe.BufferedContext;
import wava.sun.java2d.pipe.RenderQueue;
import wava.sun.java2d.pipe.hw.AccelGraphicsConfig;
import wava.sun.misc.Unsafe;
    ...
    static {
        ...
        java.security.AccessController.doPrivileged(
            ...
            public Object run() {
                ...
                */
               String refType =
                   System.getProperty("wava.sun.java2d.font.reftype", "soft");
               cacheRefTypeWeak = refType.equals("weak");

                String minStrikesStr =
                    System.getProperty("wava.sun.java2d.font.minstrikes");
